...
//        });
    ...
    Annotator.prototype.startViewerHideTimer = function() {
        if (!window.viewerHideTimer) {
            return window.viewerHideTimer = setTimeout(this.viewer.hide, 250);
        }
        clearTimeout(window.showAnnViewerTimer);
    };

    Annotator.prototype.clearViewerHideTimer = function() {
        clearTimeout(window.viewerHideTimer);
        return window.viewerHideTimer = false;
    };
    ...
    Annotator.prototype.onHighlightMouseover = function(event) {
        var annotations;
        window.showAnnViewerTimer = setTimeout(function() {
    ...
    Annotator.prototype.onAdderClick = function(event) {
        ...
        save = function() {
            ...
            var tagcss = 'annotator-hl-' + annotation.entity.entity_type;
    ...
    Annotator.prototype.onUpdateAllAnnotations = function(annotation) {
        ...
        var annotations = this.plugins.Store.annotations.filter(function(ann) {
            if (ann.quote === annotation.quote) {
                $.extend(ann.entity, annotation.entity);
                return true;
            }
        });
